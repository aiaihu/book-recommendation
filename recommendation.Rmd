...
In order to have a real book recommender, we built an book recommendation app. We used the UBCF Collaborative Filtering system to recommend the top 5 books for an user who rates the books which we give on the app. All books will be randomly given to the user to rate on the app. We need user to rate at least 5 books to get the recommendations. Ideally, the more books user rated, the better recommendation accuracy is. We deloyed our app on 
[Shinyapps.io](https://amy-hu-zhao-2001.shinyapps.io/book_recommend_shiny_app/)
Shiny App code on [github](https://github.com/aiaihu/book-recommendation-shinny-app)

Due to the limited space for the instance, we can only use a small ratings dataset for the app. 
...
* User rates more books and the recommendation model perfermances better accuracy.

* Project code on [github](https://github.com/aiaihu/book-recommendation)
