...
Before we use the books dataset, we will need to do some data cleansing to remove unuseful values. In this way, it will make the dataset smaller and make computation faster.
